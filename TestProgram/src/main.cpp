...
int main(int argc, char* argv[])
{
	...
	ConstMaterial teapotMat1; teapotMat1.albedo = { 0.972, 0.960, 0.915 }; teapotMat1.emissiveness = { 0,0,0 }; teapotMat1.reflectiveness = 0.0f; teapotMat1.isTransparent = true; teapotMat1.refractiveIndex = 1.5f; teapotMat1.reflectionLobeAngle = 0.0f; teapotMat1.transmissionLobeAngle = 3.0f;
	...
	ConstMaterial floorMat; floorMat.albedo = { 86.0f / 255.0f,125.0f / 255.0f,70.0f / 255.0f }; floorMat.emissiveness = { 0.0f,0.0f,0.0f }; floorMat.reflectiveness = 0.0f; floorMat.isTransparent = false; floorMat.reflectionLobeAngle = 11.0f;
	...
	transform = glm::translate(glm::mat4(1.0f), { 0,-0.025,-10 });
